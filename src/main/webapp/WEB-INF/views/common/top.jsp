...
<div class="container-fulid">
	<nav class="navbar navbar-light bg-light">
		<a class="navbar-brand" href="/" title="cms">
			<img alt="cms" src="/resource/images/logo3.png" class="rounded-circle" style="height: 50px">
		</a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<c:choose>
			...
			<c:when test="${sessionScope.user != null}">
				<div class="btn-group dropleft">
					<button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">${sessionScope.user.username }</button>
					<div class="dropdown-menu" style="left: -88px">
						<ul class="nav" style="margin-right: 50px">
							<li class="nav-item">
								<a class="nav-link" href="/my/">个人中心</a>
							</li>
							<li class="nav-item">
			...
			<c:otherwise>
				<ul class="nav" style="margin-right: 50px">
					<%-- 未登录显示登录注册链接 --%>
					<li class="nav-item">
						<a class="nav-link" href="/passport/reg">注册</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" href="/passport/login">登录</a>
					</li>
				</ul>
			</c:otherwise>
		</c:choose>
