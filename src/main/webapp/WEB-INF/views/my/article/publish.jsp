...
<body>
	<form id="form1" onreset="reset1()">
		<div class="form-group">
			<label for="title">文章标题:</label>
			<input class="form-control form-control-sm" id="title" type="text" name="title">
		</div>
		<div class="form-group">
			<textarea name="content1" cols="100" rows="8" style="width: 100%; height: 250px; visibility: hidden;"><%=htmlspecialchars(htmlData)%></textarea>
			<br />
		</div>
	...
	<script type="text/javascript">
		...
		$(function() {
			//先查询出所有栏目
			$.get("/channel/channels", function(result) {
