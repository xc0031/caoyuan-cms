				...
				<c:if test="${article.channelId==null }">
					...
					<div>
						...
						<c:forEach items="${info.list}" var="h">
							<div class="media">
								<img src="/pic/${h.picture}" class="mr-3 rounded" alt="..." style="height: 101px; width: 156px">
				...
				<c:if test="${article.channelId!=null }">
					<div>
						...
						<div>
							<ul class="nav">
								<li class="nav-item">
									<a class="nav-link cms-list-group-item-action ${article.categoryId==null?" cms-list-group-item-active":"" }" href="/?channelId=${article.channelId}">全部</a>
								</li>
								<c:forEach items="${categorys}" var="c">
									<li class="nav-item">
										<a class="nav-link cms-list-group-item-action ${article.categoryId==c.id?" cms-list-group-item-active":"" }" href="/?channelId=${article.channelId}&categoryId=${c.id}">${c.name}</a>
									</li>
								</c:forEach>
							</ul>
						</div>
