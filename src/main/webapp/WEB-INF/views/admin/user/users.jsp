...
<body>
	<div style="text-align: center;">
		<div class="form-group form-inline">
			...
			<input id="username" type="text" class="form-control form-control-sm" name="username" value="${user.username }">
			&nbsp;
			...
			<tbody>
				<c:forEach items="${users}" var="u" varStatus="i">
					<tr>
						...
						<td>
							<fmt:formatDate value="${u.updated }" pattern="yyyy-MM-dd HH:mm:ss" />
						</td>
						<td>
	...
	<script type="text/javascript">
		...
		function update(obj,id){
		 ...
		 //如果当前状态为正常,则改为停用.如果是停用则改为正常
			 ...
			 $.post("/admin/user/update",{id:id,locked:locked},function(result){
			      if(result.code==0){
